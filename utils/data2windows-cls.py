...
if __name__ == "__main__":
    ...
    for i in range(meta_patch.shape[0]):
        ...
        for j in range(unfolded_images.shape[0]): # we add range to it ( I think this code is generated by chatgpt :) )
            labels = unfolded_labels[j][HWout//2 , HWout//2]
            sample = {'img': unfolded_images[j], 'labels': labels, 'doy': doy}
